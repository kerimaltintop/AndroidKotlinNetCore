...
namespace AndroidKotlinNetCore.Auth
{
    public static class Config
    {
        ...
        public static IEnumerable<Client> Clients => new Client[]
        {
             ...
             new Client
             {
                 ...
                 //Access token da reflesh token ile birlikte donmesini istiyorsak true veriyoruz
                 ...
                 //token ömrünü belirtiyoruz 10dakika 10*60
                 AccessTokenLifetime=600,

                 //Refresh token kaç daha kullanılacagını belirtiyoruz
                 RefreshTokenUsage=TokenUsage.ReUse,

                 //refresh token omur
                 RefreshTokenExpiration=TokenExpiration.Absolute,
                 //Absolute(omuru sonunda biter)  
                 //Sliding(Refresh token ile omur yenilenir)
